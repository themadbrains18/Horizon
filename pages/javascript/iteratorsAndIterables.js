...
import Introduction from '@/components/iteratorsAndIterables/introduction'
import Example from '@/components/iteratorsAndIterables/example'
import IterateThroughIterables from '@/components/iteratorsAndIterables/iterateThroughIterables'
import NextMethod from '@/components/iteratorsAndIterables/nextMethod'
import UserDefinedIterator from '@/components/iteratorsAndIterables/userDefinedIterator'

const IteratorsAndIterables = () => {
...
export default IteratorsAndIterables