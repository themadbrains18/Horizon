...
import Introduction from '@/components/usesOfJavascript/introduction'
import WebpagesIntrective from '@/components/usesOfJavascript/webpagesIntrective'
import ServerSideApplication from '@/components/usesOfJavascript/serverSideApplication'
import FrontEndPages from '@/components/usesOfJavascript/frontEndPages'
import CreatingMobApps from '@/components/usesOfJavascript/creatingMobApps'
import GameDevelopment from '@/components/usesOfJavascript/gameDevelopment'


const UsesOfJavascript = () => {
...
export default UsesOfJavascript