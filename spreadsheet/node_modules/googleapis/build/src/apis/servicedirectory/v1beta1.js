...
(function (servicedirectory_v1beta1) {
    ...
    class Resource$Projects$Locations$Namespaces {
        constructor(context) {
            ...
            this.serviceWorkloads =
                new Resource$Projects$Locations$Namespaces$Serviceworkloads(this.context);
    ...
    class Resource$Projects$Locations$Namespaces$Serviceworkloads {
        constructor(context) {
            this.context = context;
        }
        getIamPolicy(paramsOrCallback, optionsOrCallback, callback) {
    ...
    servicedirectory_v1beta1.Resource$Projects$Locations$Namespaces$Serviceworkloads = Resource$Projects$Locations$Namespaces$Serviceworkloads;
